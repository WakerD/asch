...
JSON Response Example:   
```js   
{"success":true,"reward":350000000} //every single block you created will be rewarded by 3.5 OTC   
```   
...
|------ |-----  |----              |   
|success|bool  |true: response data return successfully |    
|supply|integer  |the total amount of OTC in the whole network      |    
...
JSON Response Example:   
```js   
{"success":true,"supply":10049222600000000} //There are totally 100492226 OTC in current testnet   
```   
...
|supply|integer  |total amount of OTC in the whole network      |    
...
{   
	...
	"transaction": {   
		...
		"fee": 500000000,       //the transaction fee of setting second password is 5 OTC   
		"senderId": "250438937633388106"   
	}   
}   
```   
